...
png("figures/S04B_1-yearroc_combined.tiff",width = 1500,height = 1500,res=200)
png("figures/S04B_3-yearroc_combined.tiff",width = 1500,height = 1500,res=200)
png("figures/S04B_5-yearroc_combined.tiff",width = 1500,height = 1500,res=200)
...
png("figures/S04A_cal_1y.tiff",width = 1500,height = 1500,res=200)
...
png("figures/S04A_cal_3y.tiff",width = 1500,height = 1500,res=200)
...
png("figures/S04A_cal_5y.tiff",width = 1500,height = 1500,res=200)
