...
png("figures/05D_PFSKM_risk_PRJEB23709_PD1.tiff",width = 1500,height = 1500,res=200)
...
png("figures/S03A_PFSKM_risk_response_PD1.tiff",width = 1500,height = 1500,res=200)
p <- ggsurvplot(survfit(Surv(PFS, PFS.E) ~ Group, data=survdata),size=3,
                surv.median.line = "hv",
                title = "PRJEB23709_PD1",
...
ggsave('figures/05C_barplot_PRJEB23709_PD1.tiff',P,width = 6,height = 6,dpi=200)
...
png("figures/S03B_rocyear_risk_PD1.tiff",width = 1500,height = 1500,res=200)
...
png("figures/S03C_roc_risk_PD1.tiff",width = 1500,height = 1500,res=200)
