...
png("figures/05D_PFSKM_risk_GSE100797_ACT.tiff",width = 1500,height = 1500,res=200)
...
png("figures/S03A_PFSKM_risk_response_ACT.tiff",width = 1500,height = 1500,res=200)
...
ggsave('figures/05C_barplot_GSE100797_ACT.tiff',P,width = 5,height = 5,dpi=200)
...
png("figures/S03B_rocyear_risk_ACT.tiff",width = 1500,height = 1500,res=200)
...
png("figures/S03C_roc_risk_ACT.tiff",width = 1500,height = 1500,res=200)
