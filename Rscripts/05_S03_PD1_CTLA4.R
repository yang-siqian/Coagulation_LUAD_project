...
png("figures/05D_PFSKM_risk_PRJEB23709_PD1_CTLA4.tiff",width = 1500,height = 1500,res=200)
...
png("figures/S03A_PFSKM_risk_response_PD1_CTLA4.tiff",width = 1500,height = 1500,res=200)
p <- ggsurvplot(survfit(Surv(PFS, PFS.E) ~ Group, data=survdata),size=3,
                surv.median.line = "hv",
                title = "PRJEB23709_PD1_CTLA4",
...
ggsave('figures/05C_barplot_PRJEB23709_PD1_CTLA4.tiff',P,width = 5.2,height = 5.2,dpi=200)
...
png("figures/S03B_rocyear_risk_PD1_CTLA4.tiff",width = 1500,height = 1500,res=200)
...
png("figures/S03C_roc_risk_PD1-CTLA4.tiff",width = 1500,height = 1500,res=200)
