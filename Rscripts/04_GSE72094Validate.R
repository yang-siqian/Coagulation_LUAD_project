...
library(survival)
library(survminer)
png("CRG/result/figs/05_OSKM_risk_GSE72094.tiff",width = 1500,height = 1500,res=200)
...
save(pd,file = 'CRG/extdata/GSE72094_surv398.Rdata')
load( 'CRG/extdata/GSE72094_surv398.Rdata')
...
png("CRG/result/figs/05_rocyear_risk_GSE72094.tiff",width = 1500,height = 1500,res=200)
...
png("CRG/result/figs/03_rocmethods_bsr_GSE72094.tiff",width = 1500,height = 1500,res=200)
plot(troc.1$FP, troc.1$TP, type="l",col="red", xlim=c(0,1), ylim=c(0,1), lwd=4,cex.axis=1.5,ann = F)
title(main='GSE72094',xlab="1-Specificity", ylab="Sensitivity",cex.main = 2.5, font.main= 2,cex.lab=1.6,font.lab=2)
abline(0,1,col='gray',lty=2,lwd=3)
